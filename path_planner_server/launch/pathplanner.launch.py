...
def generate_launch_description():
    ...
    controller_yaml = os.path.join(pkg_dir, 'config', 'controller_sim.yaml')
    bt_navigator_yaml = os.path.join(pkg_dir, 'config', 'bt_navigator_sim.yaml')
    planner_yaml = os.path.join(pkg_dir, 'config', 'planner_sim.yaml')
    recovery_yaml = os.path.join(pkg_dir, 'config', 'recoveries_sim.yaml')
